...
//abaixo segue os critérios necessarios para esta challenger.
...
//----- função criada  para encripitar o texto -----//
function encriptarTexto(texto){
    ...
    //Percorra o array para trocar o texto conforme o necessario
    ...
    //pega os indices do array para string
    var textoEncriptado = "".concat(...arrayTexto);
    
    //Imprime  o resultado em um input
...
//----- Função utilizada  para limpar todos inputs -----//
